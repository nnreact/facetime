...
import RingingSound from "./assets/caller.mp3";


const socket = io("https://facetime-wgmy.onrender.com");
...
function App() {
    ...
    const handleAccept = async () => {
        try {
            if (peer.signalingState === "have-remote-offer") {
                ...
                // Set showOtherVideo to true when accepting a call
        ...
        stop(); // Stop the ringing sound when call is accepted
    }

    const handleReject = () => {
        setIsCallRinging(false);
        stop(); // Stop the ringing sound when call is rejected
    }
    ...
    useEffect(() => {
        ...
        peer.ontrack = (event) => {
            ...
            // Directly set the video source if the ref is available
